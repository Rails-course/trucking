...
(function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		define([ "../../.rbenv/versions/2.6.8/lib/ruby/gems/2.6.0/gems/jquery-rails-4.5.0/vendor/assets/javascripts/jquery" ], factory );
	} else {
...
$.effects.animateClass = function( value, duration, easing, callback ) {
	...
	return this.queue( function() {
		...
		// map the animated objects to store the original assets.
		...
		// map all animated objects again - calculate new assets and diff
		allAnimations = allAnimations.map(function() {
...
var selectmenu = $.widget( "ui.selectmenu", {
	...
	_drawMenu: function() {
		...
		// Adjust menu assets to dropdown
		this.menu
		...
		if(!o.placeholder || o.placeholder.constructor === String) {
			...
			o.placeholder = {
				...
				update: function(container, p) {
					...
					//If the element doesn't have a actual height by itself (without assets coming from a stylesheet), it receives the inline height from the dragged item
