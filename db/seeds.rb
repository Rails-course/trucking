...
# jetlogistic trucks
jetlogistic_trucks = Truck.create([{ fuel_consumption: 33.33, truck_number: 667_455, truck_type: TruckType.find_by(truck_type_name: 'covered body') },
...
# gruzimvse trucks
gruzimvse_trucks = Truck.create([{ fuel_consumption: 25.03, truck_number: 739_174, truck_type: TruckType.find_by(truck_type_name: 'refrigerator') },
